...
When delegating tasks to subagents, optimize for speed and cost. High-reasoning frontier models (like Gemini Pro, Opus/Fable or GPT-6 Astra/Sol) are not always necessary for routine tasks.
