...
describe("InPageRail", () => {
  ...
  it("handles SummaryCursorView logic in summaries mode", () => {
    ...
    mockScrollContainer.getBoundingClientRect = () => ({ top: 100, bottom: 900, left: 0, right: 0, height: 800, width: 200 });
    ...
    railBody.getBoundingClientRect = () => ({ top: 150, bottom: 950, left: 0, right: 0, height: 800, width: 200 });
