// Persisted "verbose pipeline logs" toggle. When enabled, the orchestrator
// writes a processingLog entry (and console.info) for every stage — including
// per-chunk / per-topic LLM request and response events. When disabled, only
// high-level lifecycle and error stages are recorded, which keeps the service
// worker console and the record's processingLog much quieter.
//
